...
export function PublicProfilePreview({
  ...
  signupHref = "/register/seeker",
  signupLabel = "Create Profile",
  emptyDescription = "Create a profile first. CareersRX will generate the live résumé from that profile, then approved résumé section syncs will update this public page.",
